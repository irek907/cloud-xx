...
public Collection query(String strif){
    ...
    try {
        while (rs.next()) {
            ...
            readerForm.setPassword(rs.getString(15));
            readerForm.setTypename(rs.getString(16));
            readerForm.setNumber(rs.getInt(17));
           // readerForm.setPassword(rs.getString(17));
...
public ReaderForm queryM(ReaderForm readerForm){
    ...
    System.out.println("修改用户信息时的SQL："+sql);
    ResultSet rs=conn.executeQuery(sql);
    try {
        while (rs.next()) {
            ...
            readerForm1.setPassword(rs.getString(15));
