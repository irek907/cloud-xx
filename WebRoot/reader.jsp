...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：用户管理 &gt; 用户档案管理 &gt;&gt;&gt;</td>
      </tr>
      <tr>
...
%>
  ...
  <tr>
    <td>
      <a href="reader_add.jsp">添加用户信息</a> </td>
  </tr>
</table>
 <%
}else{
...
<%
  while(it.hasNext()){
	...
	password = chStr.nullToString(readerForm.getPassword(),"&nbsp;");
	%> 
  <tr>
