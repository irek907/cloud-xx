...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：用户管理 &gt; 用户类型管理 &gt;&gt;&gt;</td>
      </tr>
      <tr>
...
%>
          <table width="100%" height="30"  border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td height="36" align="center">暂无用户类型信息！</td>
            </tr>
          </table>
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      <a href="#" onClick="window.open('readerType_add.jsp','','width=292,height=175')">添加用户类型信息</a> </td>
  </tr>
</table>
 <%
}else{
 ...
 <table width="91%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="35%" bgcolor="#F9D16B">用户类型名称</td>
    <td width="35%" bgcolor="#F9D16B">权值</td>
