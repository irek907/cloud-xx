...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：用户管理 &gt; 用户档案管理 &gt; 用户详细信息 &gt;&gt;&gt;</td>
      </tr>
      <tr>
...
<%  int ID=0;
  ...
  String password = chStr.toChinese(readerForm.getPassword());
  %>
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td height="30" align="center">用&nbsp;户&nbsp;编码：</td>
        <td><input name="barcode" type="text" id="barcode" value="<%=barcode%>"></td>
      </tr>
      <tr>
        <td height="30" align="center">用户类型：</td>
